...
public class exercicioLista8dois{
   public static void main(String[] args){
       double preco1 = (0);
       double preco2 = (0);
       double preco3 = (0);
       double total = (0);
       String cardapio1 = JOptionPane.showInputDialog(null,
       "Tipo                                             Nome                                                                                        Valor\n" +
       ...
       JOptionPane.QUESTION_MESSAGE, null,
           ...
           "Filé-Mignon com fritas e cheddar", "Hambúrguer com queijos, champignon e rúcula", "Provolone com salame", "Vegetariano de berinjela", "Calabresa", "Napolitana", "Peruana", "Portuguesa"
},
""
).toString();
        ...
        String cardapio2 = JOptionPane.showInputDialog(null,
        "Tipo                                             Nome                                                                                        Valor\n" +
        "Bolos                                          Bolo Brigadeiro                                                                       R$: 29.50\n" +
        "Bolos                                          Bolo Floresta Negra                                                               R$: 2.00\n" + 
        "Bolos                                          Bolo Leite com Nutella                                                          R$: 29.23\n" + 
 ...
 ""
        ...
        String cardapio3 = JOptionPane.showInputDialog(null,
        "Tipo                                             Nome                                                                                        Valor\n" +
        "Bolos                                          Bolo Brigadeiro                                                                       R$: 29.50\n" +
        "Bolos                                          Bolo Floresta Negra                                                               R$: 2.00\n" + 
        "Bolos                                          Bolo Leite com Nutella                                                          R$: 29.23\n" + 
